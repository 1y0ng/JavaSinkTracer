...
>【注意】工具扫描出来的漏洞数量，受Sink点配置文件的影响。上述扫描过程的演示，我仅选择配置了简单的RCE、反序列化、SSRF漏洞（工具默认支持的漏洞类型也远不止如此）Sink点的扫描结果，故并未覆盖此靶场的全量漏洞。
...
留意到此项目开源2个多月后，便有师傅基于此项目，拓展了适用于 Claude 的 MCP 配置：[JavaSinkTracer_MCP](https://github.com/Zacarx/JavaSinkTracer_MCP)。欢迎各位二次开发，特别是 Todo 对应的功能。
